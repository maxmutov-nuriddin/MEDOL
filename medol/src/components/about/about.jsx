...
import Img from '../../images/about/Ellipse 4.svg'
import Imgs from '../../images/about/Ellipse 5.svg'
import Image from '../../images/about/Ellipse 6.svg'
      ...
      <div className='container'>
        ...
        <div className='about__inner d-flex justify-content-between align-items-center my-5'>
          <div className='about__img'>
            <img className='about__img1' src={Img}/>
            <img className='about__img2' src={Imgs}/>
            <img className='about__img3' src={Image}/>
